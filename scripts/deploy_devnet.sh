...
# rate pyth
anchor deploy -p rate-pyth --provider.cluster m --provider.wallet ~/Dev/VyperWallets/vyper-program-authority/authority.json
anchor idl init --provider.cluster m --provider.wallet ~/Dev/VyperWallets/vyper-program-authority/authority.json -f ./target/idl/rate_pyth.json 3mxtC2cGVhHucUg4p58MVzVqUKLyiy1zWqRkRQdgUBPT
...
# solana program deploy --buffer ./ephemeral-kp.json --upgrade-authority ~/Dev/VyperWallets/vyper-program-authority/authority.json -k ~/Dev/VyperWallets/vyper-program-authority/authority.json ./target/deploy/rate_pyth.so
